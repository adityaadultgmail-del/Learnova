...
export function TextMode() {
  ...
  return (
    <>
      ...
      >
        <h2 className="text-3xl font-bold text-slate-800 mb-6 text-center">What do you want to study?</h2>
        <form onSubmit={handleSearch} className="max-w-2xl mx-auto relative">
          <input 
            type="text" 
            placeholder="e.g. Quantum Physics, Cell Biology..."
            className="w-full bg-white/50 border-2 border-white/60 focus:border-secondary-400 rounded-full py-4 pl-6 pr-16 text-lg outline-none transition-all shadow-inner text-slate-800 placeholder:text-slate-400"
            value={topic}
            ...
            <div className="glass rounded-3xl p-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3 text-secondary-600">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800">Generated Notes</h3>
                </div>
                <button 
                  onClick={downloadPDF}
          ...
          <div className="md:col-span-4 space-y-6">
            <div className="glass rounded-3xl p-6">
              <div className="flex items-center gap-3 text-red-500 mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800">YouTube Links</h3>
              </div>
              <div className="space-y-4">
                {result.youtubeSuggestions.map((vid, idx) => (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="block p-4 rounded-2xl bg-white/40 hover:bg-white/60 border border-white/50 transition-all group"
                  >
                    <p className="font-medium text-slate-800 group-hover:text-secondary-600 line-clamp-2">{vid.title}</p>

...
export function Home() {
  ...
  return (
    <div className="space-y-12 sm:space-y-16 pb-12">
      <section className="text-center space-y-4 sm:space-y-6 max-w-2xl mx-auto pt-4 sm:pt-8">
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-800 dark:text-slate-100 tracking-tight leading-tight"
        >
          Master any topic with your{' '}
        ...
        <motion.p
          ...
          className="text-base sm:text-lg text-slate-600 dark:text-slate-400 px-2"
        >
          Choose your mode: Text Mode or Voice Mode.
        </motion.p>
      </section>

      <section className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8 max-w-4xl mx-auto">
        <Link to="/text">
          <motion.div
            whileHover={{ y: -5 }}
            className="group relative bg-secondary-600 p-6 sm:p-8 rounded-3xl text-white shadow-2xl shadow-secondary-200 overflow-hidden cursor-pointer transition-all"
          >
            ...
            <div className="relative z-10 flex flex-col items-start text-left">
              ...
              <h2 className="text-xl sm:text-2xl font-bold mb-2 text-white">Text Mode</h2>
              ...
              <div className="mt-5 flex items-center gap-2 font-semibold text-sm bg-white/10 w-fit px-4 py-2 rounded-full border border-white/20">
                Launch Text AI →
              </div>
            </div>
          </motion.div>
        ...
        <Link to="/voice">
          <motion.div
            whileHover={{ y: -5 }}
            className="group relative bg-primary-400 p-6 sm:p-8 rounded-3xl text-secondary-900 shadow-2xl shadow-primary-100 overflow-hidden cursor-pointer transition-all"
          >
            <div className="absolute -right-10 -bottom-10 w-40 h-40 bg-white/30 rounded-full blur-3xl" />
            <div className="relative z-10 flex flex-col items-start text-left">
              <div className="w-12 h-12 bg-secondary-900/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-5">
                <Mic className="w-6 h-6" />
              </div>
              <h2 className="text-xl sm:text-2xl font-bold mb-2">Voice Mode</h2>
              ...
              <div className="mt-5 flex items-center gap-2 font-semibold text-sm bg-secondary-900/10 w-fit px-4 py-2 rounded-full border border-secondary-900/10">
                Start Talking AI →
              </div>
            </div>
          </motion.div>
      ...
      <section className="max-w-5xl mx-auto pt-6 sm:pt-12">
        <div className="flex items-center justify-center gap-3 mb-8 sm:mb-10">
          <Crown className="w-6 h-6 text-primary-500" />
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 dark:text-slate-100 text-center">Premium Features</h2>
        </div>
...
function PremiumCard({
  icon, title, desc, isUnlocked, path
}: {
  ...
  if (isUnlocked) {
    return (
      <Link
        to={path}
        className="bg-gradient-to-br from-primary-50 to-white dark:from-slate-800 dark:to-slate-700 border border-primary-100 dark:border-slate-600 p-5 rounded-2xl flex flex-col gap-3 relative overflow-hidden select-none shadow-sm hover:shadow-md transition-all cursor-pointer group block"
      >
